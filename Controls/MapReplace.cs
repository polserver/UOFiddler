...
namespace FiddlerControls
{
    public partial class MapReplace : Form
    {
        ...
        public MapReplace(Ultima.Map currentMap)
        {
            InitializeComponent();
                                ...
                                else
                                {
                                    ...
                                    if (RemoveDupl.Checked)
                                    {
                                        ...
                                        for (int i = 0; i < count; ++i)
                                        {
                                            ...
                                            if (tox <= x && x <= tox2 && toy <= y && y <= toy2)
                                            {
                                                tile.m_ID = mStaticsReaderCopy.ReadUInt16();
                                                tile.m_X = mStaticsReaderCopy.ReadByte();
                                                tile.m_Y = mStaticsReaderCopy.ReadByte();
                                                tile.m_Z = mStaticsReaderCopy.ReadSByte();
                                                tile.m_Hue = mStaticsReaderCopy.ReadInt16();
                                            }
                                            else
                                            {
