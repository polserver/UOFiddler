...
{
    public class MultiEditorPlugin : Plugin
    {
        private MultiEditor.MultiEditor _multiEditor;
        ...
        public override void ModifyTabPages(TabControl tabControl)
        {
            ...
            _multiEditor = new MultiEditor.MultiEditor
            {
                Dock = DockStyle.Fill
            };
        ...
        {
            int currSelected = FiddlerControls.Options.DesignAlternative
