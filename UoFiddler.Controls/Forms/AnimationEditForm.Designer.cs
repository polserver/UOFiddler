namespace UoFiddler.Controls.Forms
{
    partial class AnimationEditForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UoFiddler.Controls.Forms.AnimationEditForm));
            ...
            this.contextMenuStripTreeView.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {this.addToolStripMenuItem, this.removeToolStripMenuItem, this.extractImagesToolStripMenuItem1, this.importToolStripMenuItem1, this.exportToolStripMenuItem1});
            ...
            this.extractImagesToolStripMenuItem1.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {this.asBmpToolStripMenuItem, this.asTiffToolStripMenuItem});
            ...
            this.importToolStripMenuItem1.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {this.fromvdToolStripMenuItem});
            ...
            this.exportToolStripMenuItem1.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {this.tovdToolStripMenuItem});
            ...
            this.toolStrip1.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {this.toolStripComboBox1});
            ...
            this.toolStripComboBox1.Items.AddRange(new object[] {"Choose anim file", "anim", "anim2", "anim3", "anim4", "anim5"});
            ...
            this.numericUpDown8.Maximum = new decimal(new int[] {255, 0, 0, 0});
            this.numericUpDown8.Minimum = new decimal(new int[] {255, 0, 0, -2147483648});
            ...
            this.numericUpDown7.Maximum = new decimal(new int[] {255, 0, 0, 0});
            this.numericUpDown7.Minimum = new decimal(new int[] {255, 0, 0, -2147483648});
            ...
            this.numericUpDown6.Minimum = new decimal(new int[] {255, 0, 0, -2147483648});
            ...
            this.contextMenuStripListView.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {this.allDirectionsAddToolStripMenuItem, this.allDirectionsAddWithCanvasToolStripMenuItem, this.addDirectionsAddWithCanvasUniqueImageToolStripMenuItem, this.allDirectionsAddWithCanvasKRframeEditorColorCorrectorToolStripMenuItem, this.addToolStripMenuItem1, this.addWithCanvasToolStripMenuItem, this.replaceToolStripMenuItem, this.removeToolStripMenuItem1});
            ...
            this.allDirectionsAddWithCanvasToolStripMenuItem.ToolTipText = ("Select 5 Gifs to add ,one by one, in a diferent direction (with canvas reduction " + "" + "algorithm)");
            ...
            this.contextMenuStripPalette.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {this.exportToolStripMenuItem, this.importToolStripMenuItem});
            ...
            this.exportToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {this.bmpToolStripMenuItem, this.tiffToolStripMenuItem, this.textToolStripMenuItem});
            ...
            this.importToolStripMenuItem.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {this.fromTxtToolStripMenuItem, this.fromGifToolStripMenuItem, this.fromImageToolStripMenuItem});
            ...
            this.toolStrip4.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {this.toolStripSeparator11, this.toolStripLabel6, this.toolStripSeparator12, this.toolStripLabel7, this.toolStripSeparator13, this.toolStripLabel8, this.toolStripLabel9, this.toolStripLabel10, this.toolStripLabel11, this.toolStripLabel12});
            ...
            this.numericUpDown2.Maximum = new decimal(new int[] {32767, 0, 0, 0});
            this.numericUpDown2.Minimum = new decimal(new int[] {32768, 0, 0, -2147483648});
            ...
            this.numericUpDownCx.Maximum = new decimal(new int[] {32767, 0, 0, 0});
            this.numericUpDownCx.Minimum = new decimal(new int[] {32768, 0, 0, -2147483648});
            ...
            this.numericUpDownCy.Maximum = new decimal(new int[] {32767, 0, 0, 0});
            this.numericUpDownCy.Minimum = new decimal(new int[] {32768, 0, 0, -2147483648});
            ...
            this.numericUpDown1.Maximum = new decimal(new int[] {32767, 0, 0, 0});
            this.numericUpDown1.Minimum = new decimal(new int[] {32768, 0, 0, -2147483648});
            ...
            this.toolStrip3.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {this.toolStripSeparator8, this.ToolStripButtonPlayAnimation, this.toolStripSeparator9, this.toolStripLabel5, this.toolStripLabel4, this.toolStripSeparator3, this.ToolStripLockButton, this.toolStripSeparator4, this.toolStripSeparator7, this.toolStripButton7, this.toolStripSeparator5, this.toolStripButton10, this.toolStripSeparator6, this.toolStripButton12, this.toolStripSeparator10});
            ...
            this.toolStrip2.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {this.toolStripLabel1, this.toolStripLabel2, this.toolStripButton1, this.toolStripButton3, this.toolStripLabel3, this.toolStripButton8, this.toolStripButton9, this.toolStripButton4, this.toolStripButton5, this.toolStripSeparator1, this.toolStripLabel13, this.toolStripSeparator2});
            ...
            this.toolStripDropDownButton1.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[] {this.saveToolStripMenuItem, this.showOnlyValidToolStripMenuItem, this.exportAllToVDToolStripMenuItem});
